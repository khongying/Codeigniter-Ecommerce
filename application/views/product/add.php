            ...
            <div style="padding-top:30px" class="panel-body" >
                ...
                <form id="form_product_add" class="form-horizontal" method="post" enctype="multipart/form-data">
                    ...
                    <div style="margin-bottom: 25px" class="input-group">
                        ...
                        <input type="text" id="code" class="form-control" name="code" placeholder="รหัสสินค้า">
                    </div> 

                    <div style="margin-bottom: 25px" class="input-group">
                        <span class="input-group-addon"><i class="fa fa-pencil"></i></span>
                        <input type="text" id="name_product" class="form-control" name="name" placeholder="ชื่อสินค้า">
                    </div> 
                    ...
                    <div style="margin-bottom: 25px" class="input-group">
                        ...
                        <input type="number" class="form-control" id="price" name="price" placeholder="ราคาสินค้า">
                    </div> 

                    <div style="margin-bottom: 25px" class="input-group">
                        <span class="input-group-addon"><i class="fa fa-cart-plus"></i></span>
                        <input type="number" class="form-control" id="total" name="total" placeholder="จำนวนสินค้า">
                    </div>
...
$(function(){
  $("#submit_from").click(function(){
    ...
    if ($('#price').val() == '') {
      swal({
            title: "กรุณาใส่รูปตัวอย่างสินค้า",
            text: null,
            type: "warning",
            showCancelButton: false
        })
