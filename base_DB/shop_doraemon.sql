...
-- Records of member
-- ----------------------------
INSERT INTO `member` VALUES ('18', 'admin@gmail.com', '1234', 'Admin', '15/10 ม.5 ต.พลิ้ว อ.แหลมสิงห์ จ.จันทบุรี', '0922720107', '1', '1');
INSERT INTO `member` VALUES ('19', 'test@gmail.com', '1234', 'สมหญิง ร่ำรวย', '15/10 ม.5 ต.พลิ้ว อ.แหลมสิงห์ จ.จันทบุรี ', '0922723107', '0', '1');
...
CREATE TABLE `product` (
  ...
  `status_product` int(1) DEFAULT '1',
  PRIMARY KEY (`id`)
...
-- Records of product
-- ----------------------------
INSERT INTO `product` VALUES ('1', 'B-001', 'กระเป๋าโดเลมอน', 'B', 'กระเป๋าโดเลมอน สีฟ้าสดใส น่ารักสุดๆ', '199', '10', '20171213080420_B12.jpg', '1');
INSERT INTO `product` VALUES ('2', 'T-001', 'เสื้อลายโดเลมอน', 'T', 'น่ารักสุด ใส่ได้ทุกวัย', '199', '5', '20171214050318_t1.jpg', '1');
INSERT INTO `product` VALUES ('3', 'C-003', 'เคส iPhone X ', 'C', 'เคส iPhone X ลายโดเลมอน ทนทาน สีไม่ตก', '200', '6', '20171214054651_c6.jpg', '1');
INSERT INTO `product` VALUES ('4', 'S-005', 'รองสุดเก๋ ', 'S', 'รองสุดเก๋  ใส่ได้ทุกวัย', '450', '6', '20171214081959_s4.jpg', '1');
INSERT INTO `product` VALUES ('5', 'W-006', 'G-Shock โดเลมอน', 'W', 'สวยมากๆเลย ', '350', '10', '20171214082137_w1.jpg', '0');
